# Dockerfile to build Binder where plotly orca works along with
# items necessary for running binderized version of 
# https://twitter.com/Steve_Harborne/status/1133064277445627904
# Orca handling with MyBinder-service based on mathieuboudreau's
# https://github.com/mathieuboudreau/orca-plotly-dockerfile/blob/master/Dockerfile . 
# See https://github.com/plotly/orca/issues/150#issuecomment-483484860 for where 
# mathieuboudreau reported working it out.
